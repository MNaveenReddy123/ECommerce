...
include "menu.html";
$sql_result = mysqli_query($conn,"select * from cart join product on cart.pid=product.pid where userid=$_SESSION[user_id]");
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            ?>
                <div class="col-md-4">
                    ...
                    <button class='btn btn-success'>Place Order</button>
                                ...
                                <a href='remove-cart.php?cartid=<?php echo $dbrow['cartid']; ?>'>
